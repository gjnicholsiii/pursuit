...
async function ensureOrganization(sql: ReturnType<typeof neon>, opportunity: SledOpportunityRecord) {
...
async function addDisciplines(sql: ReturnType<typeof neon>, projectId: number, classification: LVClassification) {
